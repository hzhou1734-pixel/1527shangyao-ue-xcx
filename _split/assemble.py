...
PAGES = [
    ...
    ('all-drugs.html', 'allDrugsPage', '全部服务 - 上药GO', 'allDrugs', False, None, ['toast'], False, None),
    ('all-merchants.html', 'allMerchantsPage', '全部诊所 - 上药GO', 'allMerchants', False, None, ['locationModal','toast'], False, None),
    ('drug-detail.html', 'drugDetailPage', '服务详情 - 上药GO', 'drug-detail', False, None, ['qrModal','toast'], False, ('onclick="goAppointment()"', 'onclick="goAppointmentForDrug()"')),
    ('merchant-detail.html', 'merchantDetailPage', '诊所详情 - 上药GO', 'merchant-detail', False, None, ['qrModal','toast','imagePreviewModal'], False, None),
    ...
    ('merchant-login.html', 'merchantLoginPage', '诊所登录 - 上药GO', 'merchant-login', False, None, ['toast'], False, None),
    ('merchant.html', 'merchantPage', '诊所中心 - 上药GO', 'merchant', False, None, ['toast'], False, None),
