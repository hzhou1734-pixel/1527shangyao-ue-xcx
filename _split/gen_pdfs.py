...
ARTICLES = [
    ...
    dict(id='a9', title='服务经营质量管理规范(GSP)现场检查要点解读', author='服务监管科学研究会', date='2026-03-30',
         cat='c3-1-1', summary='逐条解读服务经营质量管理规范对冷链、储存与追溯的要求，梳理零售药店合规自查清单。'),
    ...
    dict(id='a11', title='新版国家医保服务目录调整趋势分析', author='医保政策研究中心', date='2026-02-25',
         cat='c3-2-1', summary='分析近年医保目录谈判准入特征，解读创新药补短板惠民生的遴选逻辑。'),
    dict(id='a12', title='服务集中带量采购对临床用药结构的影响', author='卫生经济与政策组', date='2026-02-10',
         cat='c3-2-2', summary='基于带量采购落地数据，评估中选服务替代、费用节约与供应保障情况。'),
]
